...
public class CredentialsFragment extends AbstractFragment implements ImplCredentialsView, View.OnClickListener {
     ...
     private boolean createCredential = false;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TextView tvInfo = Objects.requireNonNull(getView()).findViewById(R.id.tvInfo);
        tvInfo.setOnClickListener( v -> showAlertGif() );
    ...
    private void showAlertGif() {
        LayoutInflater inflater = getLayoutInflater();
        View dialogLayout = inflater.inflate(R.layout.layout_dialog_info_gif, null);
        ImageView imgView = dialogLayout.findViewById(R.id.ivBankGif);
        Glide.with(this).load( mBank.getUrlImageGif() ).into(imgView);
